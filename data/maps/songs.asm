MapSongBanks::
	...
	db MUSIC_CITIES2, 0 ; FUCHSIA_MOVE_HOUSE
	...
	db MUSIC_CITIES2, 0 ; FUCHSIA_SUPER_ROD_HOUSE
	...
	db MUSIC_CITIES2, 0 ; ROUTE_12_GOOD_ROD_HOUSE
	...
	db MUSIC_CITIES1, 0 ; CERULEAN_BERRY_HOUSE
