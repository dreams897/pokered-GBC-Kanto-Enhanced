MtMoonB2F_Object:
	...
	def_object_events
	object_event 11, 16, SPRITE_ROCKET, STAY, DOWN, 1, OPP_ROCKET, 1
	object_event 15, 22, SPRITE_ROCKET, STAY, DOWN, 2, OPP_ROCKET, 2
	object_event 29, 11, SPRITE_ROCKET, STAY, UP, 3, OPP_ROCKET, 3
	object_event 29, 17, SPRITE_ROCKET, STAY, LEFT, 4, OPP_ROCKET, 4
	object_event 12,  8, SPRITE_SUPER_NERD, STAY, RIGHT, 5, OPP_SUPER_NERD, 2
