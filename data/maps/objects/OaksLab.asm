OaksLab_Object:
	...
	object_event  6,  3, SPRITE_POKE_BALL2, STAY, NONE, 2 ; person
	object_event  7,  3, SPRITE_POKE_BALL2, STAY, NONE, 3 ; person
	object_event  8,  3, SPRITE_POKE_BALL2, STAY, NONE, 4 ; person
