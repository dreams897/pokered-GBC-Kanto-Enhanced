...
PurpleFishingTilesFront: INCBIN "gfx/overworld/purple_fish_front.2bpp"
PurpleFishingTilesBack:  INCBIN "gfx/overworld/purple_fish_back.2bpp"
PurpleFishingTilesSide:  INCBIN "gfx/overworld/purple_fish_side.2bpp"
