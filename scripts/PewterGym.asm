...
PewterGymTrainerHeader0:
	trainer EVENT_BEAT_PEWTER_GYM_TRAINER_0, 3, PewterGymBattleText1, PewterGymEndBattleText1, PewterGymAfterBattleText1
PewterGymTrainerHeader1:
	trainer EVENT_BEAT_PEWTER_GYM_TRAINER_1, 4, PewterGymBattleText2, PewterGymEndBattleText2, PewterGymAfterBattleText2
	db -1 ; end
