	...
	tilepal 0, ROOF, ROOF, GREEN, GREEN, GREEN, GREEN, GREEN, GRAY
	tilepal 0, BROWN, GRAY, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 0, ROOF, GRAY, GREEN, GREEN, BROWN, GREEN, GREEN, GRAY
	...
	tilepal 0, BROWN, BROWN, ROOF, BROWN, ROOF, ROOF, WATER, TEXT
